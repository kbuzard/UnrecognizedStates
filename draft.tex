...
Both because of the presence of absorbing states and these state variables whose values persist from period to period, this is a dynamic game rather than a standard repeated game.

...
We will again set $R_p^{SQ}$ at its largest value of $\frac{\mu + \beta}{1-\de} -\mu$ as this is most restrictive. In this only case of interest, we have $\frac{\lambda p_{1s} - \alpha (1-p_{1s}) + \mu + \beta}{1 - \de} -\mu> 0$.

Multiplying Restriction (3) by $-(1-p_{1s})$, we have $-\beta \cdot (1-p_{1s}) \geq -\alpha \cdot (1-p_{1s})$. Using this with Restriction (4), we have $\nu p_{1s} - \beta (1-p_{1s}) \geq \lambda p_{1s} - \alpha (1-p_{1s}) + \mu + \beta> 0 \ \forall p_{1s}$ and therefore also
\[

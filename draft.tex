...
\item \emph{For both players $g$ and $s$, $\frac {Q_{i0}}{1-\delta} \geq  -\zeta_i+\frac{W_{i0}(p_1) + L_{i0}(1-p_1)}{1-\delta}$: the expected outcome under war is worse than the status quo at the beginning of the game.}
